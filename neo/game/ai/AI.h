...
public:
	...
	idActor* FindEnemyInCombatNodes(void);
	idActor* ClosestReachableEnemyOfEntity(idEntity* team_mate);
	idActor* HeardSound(int ignore_team);
...
protected:
	...
	void Script_FindEnemy(int useFOV);
	void Script_FindEnemyAI(int useFOV);
	void Script_FindEnemyInCombatNodes(void);
	void Script_ClosestReachableEnemyOfEntity(idEntity* team_mate);
	void Script_HeardSound(int ignore_team);
	void Script_SetEnemy(idEntity* ent);
	void Script_ClearEnemy(void);
	void Script_MuzzleFlash(const char* jointname);
	void Script_CreateMissile(const char* jointname);
	...
	void Script_RandomPath(void);
	void Script_BeginAttack(const char* name);
	void Script_EndAttack(void);
	void Script_MeleeAttackToJoint(const char* jointname, const char* meleeDefName);
	void Script_CanBecomeSolid(void);
	void Script_BecomeSolid(void);
	void Script_BecomeNonSolid(void);
	void Script_BecomeRagdoll(void);
	void Script_StopRagdoll(void);
	void Script_SetHealth(float newHealth);
	void Script_GetHealth(void);
	void Script_AllowDamage(void);
	void Script_IgnoreDamage(void);
	void Script_GetCurrentYaw(void);
	void Script_TurnTo(float angle);
	void Script_TurnToPos(const idVec3& pos);
	void Script_TurnToEntity(idEntity* ent);
	void Script_MoveStatus(void);
	void Script_StopMove(void);
	void Script_MoveToCover(void);
	void Script_MoveToEnemy(void);
	void Script_MoveToEnemyHeight(void);
	void Script_MoveOutOfRange(idEntity* entity, float range);
	void Script_MoveToAttackPosition(idEntity* entity, const char* attack_anim);
	void Script_MoveToEntity(idEntity* ent);
	void Script_MoveToPosition(const idVec3& pos);
	void Script_SlideTo(const idVec3& pos, float time);
	void Script_Wander(void);
	void Script_FacingIdeal(void);
	void Script_FaceEnemy(void);
	void Script_FaceEntity(idEntity* ent);
	void Script_WaitAction(const char* waitForState);
	void Script_GetCombatNode(void);
	void Script_EnemyInCombatCone(idEntity* ent, int use_current_enemy_location);
	void Script_WaitMove(void);
	void Script_GetJumpVelocity(const idVec3& pos, float speed, float max_height);
	void Script_EntityInAttackCone(idEntity* ent);
	void Script_CanSeeEntity(idEntity* ent);
	void Script_SetTalkTarget(idEntity* target);
	void Script_GetTalkTarget(void);
	void Script_SetTalkState(int state);
	void Script_EnemyRange(void);
	void Script_EnemyRange2D(void);
	void Script_GetEnemy(void);
	void Script_GetEnemyPos(void);
	void Script_GetEnemyEyePos(void);
	void Script_PredictEnemyPos(float time);
	void Script_CanHitEnemy(void);
	void Script_CanHitEnemyFromAnim(const char* animname);
	void Script_CanHitEnemyFromJoint(const char* jointname);
	void Script_EnemyPositionValid(void);
	void Script_ChargeAttack(const char* damageDef);
	void Script_TestChargeAttack(void);
	void Script_TestAnimMoveTowardEnemy(const char* animname);
	void Script_TestAnimMove(const char* animname);
	void Script_TestMoveToPosition(const idVec3& position);
	...
	void Script_GetTurnDelta(void);
	void Script_GetMoveType(void);
	void Script_SetMoveType(int moveType);
	void Script_SaveMove(void);
	void Script_RestoreMove(void);
	void Script_AllowMovement(float flag);
	void Script_JumpFrame(void);
	void Script_EnableClip(void);
	void Script_DisableClip(void);
	void Script_EnableGravity(void);
	void Script_DisableGravity(void);
	void Script_EnableAFPush(void);
	void Script_DisableAFPush(void);
	void Script_SetFlySpeed(float speed);
	void Script_SetFlyOffset(int offset);
	void Script_ClearFlyOffset(void);
	void Script_GetClosestHiddenTarget(const char* type);
	void Script_GetRandomTarget(const char* type);
	void Script_TravelDistanceToPoint(const idVec3& pos);
	void Script_TravelDistanceToEntity(idEntity* ent);
	void Script_TravelDistanceBetweenPoints(const idVec3& source, const idVec3& dest);
	void Script_TravelDistanceBetweenEntities(idEntity* source, idEntity* dest);
	void Script_LookAtEntity(idEntity* ent, float duration);
	void Script_LookAtEnemy(float duration);
	void Script_SetJointMod(int allow);
	void Script_ThrowMoveable(void);
	void Script_ThrowAF(void);
	void Script_SetAngles(const idAngles& ang);
	void Script_GetAngles(void);
	void Script_RealKill(void);
	void Script_Kill(void);
	void Script_WakeOnFlashlight(int enable);
	void Script_LocateEnemy(void);
	void Script_KickObstacles(idEntity* kickEnt, float force);
	void Script_GetObstacle(void);
	void Script_PushPointIntoAAS(const idVec3& pos);
	void Script_GetTurnRate(void);
	void Script_SetTurnRate(float rate);
	void Script_AnimTurn(float angles);
	void Script_AllowHiddenMovement(int enable);
	void Script_TriggerParticles(const char* jointName);
	void Script_FindActorsInBounds(const idVec3& mins, const idVec3& maxs);
	void Script_CanReachPosition(const idVec3& pos);
